...
import {LIVES_START} from './config.js';
...
export function resetAll(){S.score=0;S.boneCount=0;S.lives=LIVES_START;S.time=0;S.playFrames=0;S.checkpointIndex=-1;S.powerTimer=0;S.combo=0;S.particles.length=0;S.popups.length=0;S.shots=[];S.chargeTimer=0;S.fireCooldown=0;
